...
console.log("Elucidat.com Rapid Authoring (v.#build_version#) built with love on 2023-02-14 06:02:43");
/* 
notes - to add:
    1.2
        cmi.core.student_id
...
Elucidat = function (options, lrs_activity_id, lrs_endpoints) {
    ...
    context.init();
    // now navigation
    this._load_navigation({"template":"<li class=\"menu__item {{page.is_section}} {{page.active}} e-no-controls\">\n    <a href=\"{{page.url}}\" class=\"itemInner menu__item__inner\" title=\"{{page.name}}\" data-dismiss=\"dropdown\">\n        <span class=\"icon\">\n            <i class=\"ti ti-lock\"><span class=\"focusHelper\"><\/span><\/i>\n        <\/span>\n        <span class=\"text e-no-controls\">{{page.name}}<\/span>\n    <\/a>\n    {{page.sub_pages}}\n<\/li>","url_format":"pages\/%s.js","pages":{"627d71eb2f6f0":{"n":"How to Set your Preferences in the EHR","mn":false,"mod":false,"hol":false,"sec":true,"i":true,"s":1,"b":"_627d79c6e1275","v":"viewed","d":true},"627d71eb35176":{"n":"Preferences to Know","mn":false,"mod":false,"hol":false,"sec":false,"i":true,"b":"_62ebf1549835a","v":"viewed","p":"627d71eb2f6f0"}}});
    // get learner name
